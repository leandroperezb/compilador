...
void AnalizadorLexico::inicializarMatrizDeTransiciones(){
	...
	matrizTransiciones[ESTADO_LEYENDO_IGUAL][CATEGORIA_ENDLINE] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_IGUAL][CATEGORIA_FIN_ARCHIVO] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_IGUAL][CATEGORIA_ESPACIO] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_IGUAL][CATEGORIA_COMENTARIO] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_IGUAL][CATEGORIA_INICIOCADENA] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_IGUAL][CATEGORIA_GUIONBAJO] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_IGUAL][CATEGORIA_FINCADENA] = {ESTADO_INICIAL, &AccionesSemanticas::error};




	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_DIGITO] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_LETRA] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_DOSPUNTOS] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_IGUAL] = {ESTADO_FINAL, &AccionesSemanticas::entregarAsignacion};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_MENOR] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_MAYOR] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_OPERADOR] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_INVALIDO] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_ENDLINE] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_FIN_ARCHIVO] = {ESTADO_INICIAL, &AccionesSemanticas::tokenFinal};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_ESPACIO] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_COMENTARIO] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_INICIOCADENA] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_GUIONBAJO] = {ESTADO_INICIAL, &AccionesSemanticas::error};
	matrizTransiciones[ESTADO_LEYENDO_ASIGNACION][CATEGORIA_FINCADENA] = {ESTADO_INICIAL, &AccionesSemanticas::error};
